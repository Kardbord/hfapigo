...
import (
	...
	"github.com/Kardbord/hfapigo/v4/internal/service"
)
...
func NewClient(opts ...api.RequestOption) Client {
	return Client{
...
func (c Client) Chat() ChatService {
	return service.NewChatService(c.opts)
}
...
func (c Client) Raw() RawService {
	return service.NewRawService(c.opts)
}
